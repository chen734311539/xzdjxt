<template style="width:100%;height:100%;">
  <div class="login">
      ...
      <div class="login_right">
          ...
          <div class="login_userdiv" style="margin-top:40px;">
...
.login_userdiv{ width:243px; height:26px; margin:auto; margin-top:40px; border-bottom:1px solid #20d4ea;}
.login_userdiv img{ float:left; margin-right:10px;}
.login_userdiv input{ float:left; width:210px; height:18px; border:none; color:#20d4ea; font-size:14px; background:none; outline:none;letter-spacing:2px}
/* 设置登录自动填充的样式 */
...
.login_userbtndiv{ width:243px; height:32px; margin:auto;background:url(./../../assets/login/login_right_btn.png); background-size:100% 100%; color:white; text-align:center; line-height:32px; margin-top:30px;}
...
.login_userbtnmiyao{width:243px; height:32px; margin:auto;text-align:center; line-height:32px; margin-top:70px; border:1px solid #20d4ea; color:#20d4ea; border-radius:100px;}
