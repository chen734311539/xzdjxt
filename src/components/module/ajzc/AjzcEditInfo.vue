<template>
    <Modal v-model="showdata.showmodal" :draggable = "true" :footer-hide="true" title="修改案件侦查主题" class-name="ajzcEditItem-panel">
        ...
        <div style="display:block;">
            <div style="height: 570px;">
                ...
                <div class="ajzcEditContentPanel">
                    <div class="uespanel">
                        <UE :defaultMsg="defaultMsg" :config="config" ref="ue" ueid="ajzcedit"></UE>
                    </div>
                </div>
            </div>
...
export default {
  ...
  methods:{
      addAjzcItem(){
          ...
          updateItemParamObj.ab = this.ab;
          updateItemParamObj.jz = this.jz;
          updateItemParamObj.ajmc = this.ajmc;
          updateItemParamObj.sswp = this.sswp;
          updateItemParamObj.hjzw = this.hjzw;
          updateItemParamObj.zasd = this.zasd;
          updateItemParamObj.afsj = this.afsj;
          ...
          this.http.post("/qzlq/updateAjzcItem",updateItemParamObj,this.updateAjzcItemCallBack,this,false);
      },
      ...
      getAjzcItemDetailByIdCallBack(result){
          ...
          this.ajbh = itemdata.ajbh;
          this.ab = itemdata.ab;
          this.jz = itemdata.jz;
          this.ajmc = itemdata.ajmc;
          this.sswp = itemdata.sswp;
          this.hjzw = itemdata.hjzw;
          this.zasd = itemdata.zasd;
          this.afsj = itemdata.afsj;
