<template>
    <div class="ajzcItemButton" @click="showFollowPanel" @mouseover="mouseOver" @mouseout="mouseOut">
      <div class="ajzcbuttonTX" :class="ajzcbuttonBorder">
        ...
        <div class="content">
            ...
            <div class="caozuo" v-show="showEditIcon" >
              <div class="mdyIcon" @click="editAjzcItem" ></div>
            </div>
         </div>
        <div :class="state">
        </div>
...
export default {
  ...
  data () {
    return {
        ...
        ajzcbuttonBorder:"ajzcbuttonBorder_leave",
    }
  },
  computed: {
    titlespan:function(){
  ...
  methods:{
    ...
    mouseOver(){
       ...
       this.ajzcbuttonBorder="ajzcbuttonBorder_enter";
     },
     mouseOut(){
       this.showEditIcon = false;
       this.ajzcbuttonBorder="ajzcbuttonBorder_leave";
     },
     editAjzcItem(){
        this.$emit("show-edit",true);
     },
     showFollowPanel(){
       this.initRightPaneldata(this.data.id,"ajzc");
     }
  },
  created(){
...
.ajzcbuttonTX:hover, .ajzcbuttonTX:focus, .ajzcbuttonTX:active {
    cursor: pointer;
