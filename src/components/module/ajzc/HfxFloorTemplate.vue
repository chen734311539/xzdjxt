            ...
            <div class="floorleft">
             ...
             <div class="floormiddle">
               <div class="contenthtml">
                  <div v-html="contentObj.content" class="contentdoc">{{contentObj.content}}</div>
                </div>
            </div>
             <div class="floorright">
               <div class="floornum">
               <em style="color:#e6b39d;">{{contentObj.seq-1}}楼</em>
               </div>
                <div v-show="isshoweditbtn" class="editbutton">
                  <a style="color:#fff;"  @click="commentReply(JSON.stringify(contentObj))">回复</a>
                  <a style="color:#fff;"  @click="editReply(JSON.stringify(contentObj))">编辑</a>
                  <a style="color:#fff;"  @click="deleteReply(JSON.stringify(contentObj))" v-show="contentObj.seq!='1'" >删除</a>
                </div>
