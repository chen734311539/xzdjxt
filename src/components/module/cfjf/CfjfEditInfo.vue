<template>
    <Modal v-model="showdata.showmodal" :draggable = "true" :footer-hide="true" title="修改重复纠纷主题" class-name="cfjfEditItem-panel">
        ...
        <div style="display:block;">
            <div style="height: 570px;">
                ...
                <div class="cfjfEditContentPanel">
                    <div class="uespanel">
                        <UE :defaultMsg="defaultMsg" :config="config" ref="ue" ueid="cfjfedit"></UE>
                    </div>
                </div>
            </div>
...
export default {
  ...
  methods:{
      addCfjfItem(){
          ...
          this.http.post("/qzlq/updateCfjfItem",updateItemParamObj,this.updateCfjfItemCallBack,this,false);
      },
