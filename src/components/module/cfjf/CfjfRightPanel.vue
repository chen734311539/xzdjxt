        ...
        <HfxFollowTemplate  :itemdata="itemdata" :contentlist="contentlist" @on-commentreply="commentReply" @on-editreply="editReply" @on-deletereply="deleteReply" >
            <template #titlebutton="{data}">
                ...
                <Poptip v-model="showPop" zIndex="2000" placement="bottom" class="item_option_btn">
                   ...
                   <div slot="content" style="calc(100% - 10px);color:#2d8cf0;min-width:60px">
                        ...
                        <div v-show="itemdata.state!='3'" class="itemoption" @click="updateItemstate(3)">化解</div>
            ...
            <template #editfollowpanel="{data}">
                <div class="addueditor">
                    <UE :defaultMsg="defaultMsg" :config="config" ref="ue" ueid="cfjfaddfollow"></UE>
                </div>
...
export default {
  ...
  methods:{
      initEditValues(val){//初始化修改的值
        ...
        paramObj.itemid = val;
        this.http.get("/qzlq/getCfjfItemDetailById",paramObj,this.getCfjfItemDetailByIdCallBack,this,false);
      },
      ...
      getCfjfItemDetailByIdCallBack(result){
      ...
      submitEditContent(){//发表评论
        ...
        if(this.selectusers.length==0){
            this.http.post("/qzlq/insertCfjfItemContent",paramObj,this.insertCfjfItemContentCallBack,this,false);
        }else{
            ...
            this.$msgbox({
              ...
              beforeClose: (action, instance, done) => {
                if (action === 'confirm') {
                  ...
                  paramObj.msg = "重复纠纷["+this.itemdata.title+"]主题下添加了关于您的新的信息，请注意查看！";
                  this.http.post("/qzlq/insertCfjfItemContent",paramObj,this.insertCfjfItemContentCallBack,this,false);
                } else {
                  done();
                }
      ...
      deleteReply(val){
          ...
          this.http.get("/qzlq/deleteCfjfItemContent",paramObj,this.deleteCfjfItemContentCallBack,this,false);
      },
      deleteCfjfItemContentCallBack(reslut){
          this.reflashItem(this.itemdata.id);
      },
      editReply(val){
          var obj=JSON.parse(val);
      ...
      replaysubmitEditContent(){
          ...
          this.http.post("/qzlq/updateCfjfItemContent",paramObj,this.updateCfjfItemContentCallBack,this,false);
      },
      updateCfjfItemContentCallBack(result){
          this.showsubmitbtn = "1";
          this.reflashItem(this.itemdata.id);
          this.$refs.ue.setUEContent("");//重置编辑器
      },
      ...
      setItemTop(val){
          ...
          paramObj.itemid = this.itemdata.id;
          if(val==1){
              this.http.get("/qzlq/updateCfjfItemTop",paramObj,this.updateCfjfItemCallBack,this,false);
          }else{
              this.http.get("/qzlq/cancelCfjfItemTop",paramObj,this.updateCfjfItemCallBack,this,false);
          }
      },
      setItemFollow(val){
          var paramObj = {};
          paramObj.itemid = this.itemdata.id;
          if(val==1){
              this.http.get("/qzlq/updateCfjfItemFollow",paramObj,this.updateCfjfItemCallBack,this,false);
          }else{
              this.http.get("/qzlq/cancelCfjfItemFollow",paramObj,this.updateCfjfItemCallBack,this,false);
          }
      },
      deleteItem(){
          var paramObj = {};
          paramObj.itemid = this.itemdata.id;
          this.http.get("/qzlq/deleteCfjfItem",paramObj,this.deleteCfjfItemCallBack,this,false);
      },
      deleteCfjfItemCallBack(){
          this.itemdata = {};
          this.contentlist = [];
          this.page = 1;
          this.totalSize = 0;
      ...
      updateItemstate(val){
          ...
          paramObj.itemid = this.itemdata.id;
          paramObj.state = val;
          this.http.get("/qzlq/updateCfjfItemState",paramObj,this.updateCfjfItemCallBack,this,false);
      },
      updateCfjfItemCallBack(result){
          this.showPop = false;
          this.reflashItem(this.itemdata.id);
      },
      pageChange(page){
...
.cfjffollowpanel >>> .edui-default .edui-editor {
