<template>
    <Modal v-model="showdata.showmodal" :draggable = "true" :footer-hide="true" title="新增警情质量主题" class-name="jqzlEditItem-panel">
...
export default {
  ...
  methods:{
      addJqzlItem(){
          ...
          this.http.post("/qzlq/insertJqzlItem",addItemParamObj,this.insertJqzlItemCallBack,this,false);
      },
      insertJqzlItemCallBack(result){
