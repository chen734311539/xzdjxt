<template>
    <Modal v-model="showdata.showmodal" :draggable = "true" :footer-hide="true" title="修改警情质量主题" class-name="jqzlEditItem-panel">
      <div slot="close"><div class="hfx-modal-close"/></div>
        <div style="display:block;">
            <div style="height: 570px;">
                <div class="jqzlEditPanel">
                    <div class="modal-div">
                        <span>选择参与部门：</span>
                ...
                <div class="jqzlEditContentPanel">
                    <div class="uespanel">
                        <UE :defaultMsg="defaultMsg" :config="config" ref="ue" ueid="jqzledit"></UE>
                    </div>
                </div>
            </div>
            <div class="jqzlEditBtn">
                <HfxButton  @click="addJqzlItem" />
                <HfxButton  @click="closeJqzl" name="取消" />
            </div>
        </div>
    </Modal>
</template>
...
export default {
  ...
  computed: mapState({
    ...
    deptListObj: state => state.jqzl.allDeptListObj
  }),
  methods:{
      addJqzlItem(){
          ...
          this.http.post("/qzlq/updateJqzlItem",updateItemParamObj,this.updateJqzlItemCallBack,this,false);
      },
      ...
      getDeptTreeCallBack(data){
         this.$store.dispatch('putChildState',{"key":"jqzl","childkey":"allDeptListObj","value":data});
      },
...
.jqzlEditItem-panel .ivu-modal .ivu-modal-content{
  top:180px;
  left:495px;
