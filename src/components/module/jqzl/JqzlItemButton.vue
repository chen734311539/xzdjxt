<template>
    <div class="jqzlItemButton" @click="showFollowPanel" @mouseover="mouseOver" @mouseout="mouseOut">
      <div class="jqzlbuttonTX" :class="jqzlbuttonBorder">
        ...
        <div class="content">
            ...
            <div class="caozuo" v-show="showEditIcon" >
              <div class="mdyIcon" @click="editJqzlItem" ></div>
            </div>
         </div>
        <div :class="state">
        </div>
...
export default {
  ...
  data () {
    return {
        ...
        jqzlbuttonBorder:"jqzlbuttonBorder_leave",
    }
  },
  computed: {
    titlespan:function(){
  ...
  methods:{
    ...
    mouseOver(){
       ...
       this.jqzlbuttonBorder="jqzlbuttonBorder_enter";
     },
     mouseOut(){
       this.showEditIcon = false;
       this.jqzlbuttonBorder="jqzlbuttonBorder_leave";
     },
     editJqzlItem(){
         this.$emit("show-edit",true);
     },
     showFollowPanel(){
       this.initRightPaneldata(this.data.id,"jqzl");
     }
  },
  created(){
...
.jqzlbuttonTX:hover, .jqzlbuttonTX:focus, .jqzlbuttonTX:active {
    cursor: pointer;
...
.mdyIcon{
  ...
  margin-right:10px;
  background: 
  url(./../../../assets/jqzl/jqzl_mdy.png)  no-repeat;
}
.state_xinzeng{
  position: absolute;
  right: 5px;
  ...
  height: 45px;
  background: 
  url(./../../../assets/jqzl/jqzl_xinzeng.png)  no-repeat;
}
.state_xubao{
  position: absolute;
  right: 5px;
  ...
  height: 45px;
  background: 
  url(./../../../assets/jqzl/jqzl_xubao.png)  no-repeat;
}
.state_jiechu{
  position: absolute;
  right: 5px;
  ...
  height: 45px;
  background: 
  url(./../../../assets/jqzl/jqzl_jiechu.png)  no-repeat;
}
</style>
