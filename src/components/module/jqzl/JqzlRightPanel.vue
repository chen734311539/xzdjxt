            ...
            <template #titlebutton="{data}">
                ...
                <Poptip v-model="showPop" zIndex="2000" placement="bottom" class="item_option_btn">
                    ...
                    <div slot="content" style="calc(100% - 10px);color:#2d8cf0;min-width:60px">
                        ...
                        <!-- <div v-show="itemdata.state!='3'" class="itemoption" @click="updateItemstate(3)">解除</div>
                        <div v-show="itemdata.state!='2'" class="itemoption" @click="updateItemstate(2)">续报</div> -->
                    </div>
                  </Poptip>
            </template>
            <template #editfollowpanel="{data}">
                <div class="addueditor">
                    <UE :defaultMsg="defaultMsg" :config="config" ref="ue" ueid="jqzladdfollow"></UE>
                </div>
...
export default {
  ...
  methods:{
      initEditValues(val){//初始化修改的值
        ...
        paramObj.itemid = val;
        this.http.get("/qzlq/getJqzlItemDetailById",paramObj,this.getJqzlItemDetailByIdCallBack,this,false);
      },
      ...
      getJqzlItemDetailByIdCallBack(result){
      ...
      submitEditContent(){//发表评论
        ...
        if(this.selectusers.length==0){
            this.http.post("/qzlq/insertJqzlItemContent",paramObj,this.insertJqzlItemContentCallBack,this,false);
        }else{
      ...
      deleteReply(val){
          ...
          this.http.get("/qzlq/deleteJqzlItemContent",paramObj,this.deleteJqzlItemContentCallBack,this,false);
      },
      deleteJqzlItemContentCallBack(reslut){
          this.reflashItem(this.itemdata.id);
      },
      editReply(val){
            var obj=JSON.parse(val);
      ...
      replaysubmitEditContent(){
          ...
          this.http.post("/qzlq/updateJqzlItemContent",paramObj,this.updateJqzlItemContentCallBack,this,false);
      },
      updateJqzlItemContentCallBack(result){
          this.showsubmitbtn = "1";
          this.reflashItem(this.itemdata.id);
          this.$refs.ue.setUEContent("");//重置编辑器
      },
      ...
      setItemTop(val){
          ...
          paramObj.itemid = this.itemdata.id;
          if(val==1){
              this.http.get("/qzlq/updateJqzlItemTop",paramObj,this.updateJqzlItemCallBack,this,false);
          }else{
              this.http.get("/qzlq/cancelJqzlItemTop",paramObj,this.updateJqzlItemCallBack,this,false);
          }
      },
      setItemFollow(val){
          var paramObj = {};
          paramObj.itemid = this.itemdata.id;
          if(val==1){
              this.http.get("/qzlq/updateJqzlItemFollow",paramObj,this.updateJqzlItemCallBack,this,false);
          }else{
              this.http.get("/qzlq/cancelJqzlItemFollow",paramObj,this.updateJqzlItemCallBack,this,false);
          }
      },
      deleteItem(){
          var paramObj = {};
          paramObj.itemid = this.itemdata.id;
          this.http.get("/qzlq/deleteJqzlItem",paramObj,this.deleteJqzlItemCallBack,this,false);
      },
      deleteJqzlItemCallBack(){
          this.itemdata = {};
          this.contentlist = [];
          this.page = 1;
          this.totalSize = 0;
      ...
      updateItemstate(val){
          ...
          paramObj.itemid = this.itemdata.id;
          paramObj.state = val;
          this.http.get("/qzlq/updateJqzlItemState",paramObj,this.updateJqzlItemCallBack,this,false);
      },
      updateJqzlItemCallBack(result){
          this.showPop = false;
          this.reflashItem(this.itemdata.id);
      },
      pageChange(page){
...
.jqzlfollowpanel >>> .edui-default .edui-editor {
