<template>
    <Modal v-model="showdata.showmodal" :draggable = "true" :footer-hide="true" title="新增请求服务主题" class-name="qqfwEditItem-panel">
...
export default {
  ...
  methods:{
      addQqfwItem(){
          ...
          addItemParamObj.rylb = this.rylb;
          ...
          this.http.post("/qzlq/insertQqfwItem",addItemParamObj,this.insertQqfwItemCallBack,this,false);
      },
      insertQqfwItemCallBack(result){
