<template>
    <Modal v-model="showdata.showmodal" :draggable = "true" :footer-hide="true" title="修改请求服务主题" class-name="qqfwEditItem-panel">
        <div slot="close"><div class="hfx-modal-close"/></div>
        <div style="display:block;">
            <div style="height: 570px;">
                <div class="qqfwEditPanel">
                    <div class="modal-div">
                        <span>选择参与部门：</span>
                    ...
                    <div class="modal-div">
                        <span>人员状态：</span>
                        <select class="inputclass" v-model="rylb">
                            <option value="0">选择人员类别</option>
                            <option value="1">在逃人员</option>
                            <option value="2">嫌疑人员</option>
                            <option value="3">重点人员</option>
                ...
                <div class="qqfwEditContentPanel">
                    <div class="uespanel">
                        <UE :defaultMsg="defaultMsg" :config="config" ref="ue" ueid="qqfwedit"></UE>
                    </div>
                </div>
            </div>
            <div class="qqfwEditBtn">
                <HfxButton  @click="addQqfwItem" />
                <HfxButton  @click="closeQqfw" name="取消" />
            </div>
        </div>
    </Modal>
</template>
...
export default {
  ...
  computed: mapState({
    ...
    deptListObj: state => state.qqfw.allDeptListObj
  }),
  methods:{
      addQqfwItem(){
          ...
          updateItemParamObj.rylb = this.rylb;
          ...
          this.http.post("/qzlq/updateQqfwItem",updateItemParamObj,this.updateQqfwItemCallBack,this,false);
      },
      ...
      getDeptTreeCallBack(data){
         this.$store.dispatch('putChildState',{"key":"qqfw","childkey":"allDeptListObj","value":data});
      },
...
.qqfwEditItem-panel .ivu-modal .ivu-modal-content{
