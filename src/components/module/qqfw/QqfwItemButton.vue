<template>
    <div class="qqfwItemButton" @click="showFollowPanel" @mouseover="mouseOver" @mouseout="mouseOut">
      <div class="qqfwbuttonTX" :class="qqfwbuttonBorder">
      </div>
        <div class="content">
            ...
            <div class="caozuo" v-show="showEditIcon" >
              <div class="mdyIcon" @click="editQqfwItem" ></div>
            </div>
         </div>
        <div :class="state">
        </div>
...
export default {
  ...
  data () {
    return {
        ...
        qqfwbuttonBorder:"qqfwbuttonBorder_leave",
    }
  },
  computed: {
    titlespan:function(){
  ...
  methods:{
    ...
    mouseOver(){
       ...
       this.qqfwbuttonBorder="qqfwbuttonBorder_enter";
     },
     mouseOut(){
     ...
     showFollowPanel(){
       this.initRightPaneldata(this.data.id,"qqfw");
     }
  },
  created(){
...
.qqfwbuttonTX:hover, .qqfwbuttonTX:focus, .qqfwbuttonTX:active {
    cursor: pointer;
...
.state_xinzeng{
  ...
  height: 45px;
  background: 
  url(./../../../assets/qqfw/qqfw_xinzeng.png)  no-repeat;
}
.state_yanpan{
  position: absolute;
  right: 5px;
  ...
  height: 45px;
  background: 
  url(./../../../assets/qqfw/qqfw_yanpan.png)  no-repeat;
}
.state_wancheng{
  position: absolute;
  right: 5px;
  ...
  height: 45px;
  background: 
  url(./../../../assets/qqfw/qqfw_wancheng.png)  no-repeat;
}
</style>
