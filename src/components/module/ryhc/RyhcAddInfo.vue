<template>
    <Modal v-model="showdata.showmodal" :draggable = "true" :footer-hide="true" title="新增人员核查主题" class-name="ryhcEditItem-panel">
...
export default {
  ...
  methods:{
      addRyhcItem(){
          ...
          this.http.post("/qzlq/insertRyhcItem",addItemParamObj,this.insertRyhcItemCallBack,this,false);
      },
      insertRyhcItemCallBack(result){
