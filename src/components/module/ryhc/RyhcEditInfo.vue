<template>
    <Modal v-model="showdata.showmodal" :draggable = "true" :footer-hide="true" title="修改人员核查主题" class-name="ryhcEditItem-panel">
        <div slot="close"><div class="hfx-modal-close"/></div>
        <div style="display:block;">
            <div style="height: 570px;">
                <div class="ryhcEditPanel">
                    <div class="modal-div">
                        <span>选择参与部门：</span>
                ...
                <div class="ryhcEditContentPanel">
                    <div class="uespanel">
                        <UE :defaultMsg="defaultMsg" :config="config" ref="ue" ueid="ryhcedit"></UE>
                    </div>
                </div>
            </div>
            <div class="ryhcEditBtn">
                <HfxButton  @click="addRyhcItem" />
                <HfxButton  @click="closeRyhc" name="取消" />
            </div>
        </div>
    </Modal>
</template>
...
export default {
  ...
  computed: mapState({
    ...
    deptListObj: state => state.ryhc.allDeptListObj
  }),
  methods:{
      addRyhcItem(){
          ...
          this.http.post("/qzlq/updateRyhcItem",updateItemParamObj,this.updateRyhcItemCallBack,this,false);
      },
      ...
      getDeptTreeCallBack(data){
         this.$store.dispatch('putChildState',{"key":"ryhc","childkey":"allDeptListObj","value":data});
      },
...
.ryhcEditItem-panel .ivu-modal .ivu-modal-content{
