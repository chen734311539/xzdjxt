<template>
    <div class="ryhcRightPanel">
    <LeftContentNameBar :isshowshaixuan="false"  style="margin:0 0 0 0;" />
    <div  v-if="contentlist.length>0"  class="ryhcfollowpanel">
        <HfxFollowTemplate  :itemdata="itemdata" :contentlist="contentlist" @on-commentreply="commentReply" @on-editreply="editReply" @on-deletereply="deleteReply" >
            ...
            <template #editfollowpanel="{data}">
                <div class="addueditor">
                    <UE :defaultMsg="defaultMsg" :config="config" ref="ue" ueid="ryhcaddfollow"></UE>
                </div>
...
export default {
  ...
  methods:{
      initEditValues(val){//初始化修改的值
        ...
        paramObj.itemid = val;
        this.http.get("/qzlq/getRyhcItemDetailById",paramObj,this.getRyhcItemDetailByIdCallBack,this,false);
      },
      ...
      getRyhcItemDetailByIdCallBack(result){
      ...
      submitEditContent(){//发表评论
        ...
        if(this.selectusers.length==0){
            this.http.post("/qzlq/insertRyhcItemContent",paramObj,this.insertRyhcItemContentCallBack,this,false);
        }else{
            ...
            this.$msgbox({
              ...
              beforeClose: (action, instance, done) => {
                if (action === 'confirm') {
                  ...
                  paramObj.msg = "人员核查["+this.itemdata.title+"]主题下添加了关于您的新的信息，请注意查看！";
                  this.http.post("/qzlq/insertRyhcItemContent",paramObj,this.insertRyhcItemContentCallBack,this,false);
                } else {
                  done();
                }
      ...
      deleteReply(val){
          ...
          this.http.get("/qzlq/deleteRyhcItemContent",paramObj,this.deleteRyhcItemContentCallBack,this,false);
      },
      deleteRyhcItemContentCallBack(reslut){
          this.reflashItem(this.itemdata.id);
      },
      editReply(val){
          var obj=JSON.parse(val);
      ...
      replaysubmitEditContent(){
          ...
          this.http.post("/qzlq/updateRyhcItemContent",paramObj,this.updateRyhcItemContentCallBack,this,false);
      },
      updateRyhcItemContentCallBack(result){
          this.showsubmitbtn = "1";
          this.reflashItem(this.itemdata.id);
          this.$refs.ue.setUEContent("");//重置编辑器
      },
      ...
      setItemTop(val){
          ...
          paramObj.itemid = this.itemdata.id;
          if(val==1){
              this.http.get("/qzlq/updateRyhcItemTop",paramObj,this.updateRyhcItemCallBack,this,false);
          }else{
              this.http.get("/qzlq/cancelRyhcItemTop",paramObj,this.updateRyhcItemCallBack,this,false);
          }
      },
      setItemFollow(val){
          var paramObj = {};
          paramObj.itemid = this.itemdata.id;
          if(val==1){
              this.http.get("/qzlq/updateRyhcItemFollow",paramObj,this.updateRyhcItemCallBack,this,false);
          }else{
              this.http.get("/qzlq/cancelRyhcItemFollow",paramObj,this.updateRyhcItemCallBack,this,false);
          }
      },
      deleteItem(){
          var paramObj = {};
          paramObj.itemid = this.itemdata.id;
          this.http.get("/qzlq/deleteRyhcItem",paramObj,this.deleteRyhcItemCallBack,this,false);
      },
      deleteRyhcItemCallBack(){
          this.itemdata = {};
          this.contentlist = [];
          this.page = 1;
          this.totalSize = 0;
      ...
      updateItemstate(val){
          ...
          paramObj.itemid = this.itemdata.id;
          paramObj.state = val;
          this.http.get("/qzlq/updateRyhcItemState",paramObj,this.updateRyhcItemCallBack,this,false);
      },
      updateRyhcItemCallBack(result){
          this.showPop = false;
          this.reflashItem(this.itemdata.id);
      },
      pageChange(page){
...
.ryhcfollowpanel >>> .edui-default .edui-editor {
