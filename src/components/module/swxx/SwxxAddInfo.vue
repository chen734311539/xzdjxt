<template>
    <Modal v-model="showdata.showmodal" :draggable = "true" :footer-hide="true" title="新增涉稳信息主题" class-name="swxxEditItem-panel">
...
export default {
  ...
  methods:{
      addSwxxItem(){
          ...
          this.http.post("/qzlq/insertSwxxItem",addItemParamObj,this.insertSwxxItemCallBack,this,false);
      },
      insertSwxxItemCallBack(result){
