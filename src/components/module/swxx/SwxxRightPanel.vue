        ...
        <HfxFollowTemplate  :itemdata="itemdata" :contentlist="contentlist" @on-commentreply="commentReply" @on-editreply="editReply" @on-deletereply="deleteReply" >
            ...
            <template #editfollowpanel="{data}">
                <div class="addueditor">
                    <UE :defaultMsg="defaultMsg" :config="config" ref="ue" ueid="swxxaddfollow"></UE>
                </div>
...
export default {
  ...
  methods:{
      initEditValues(val){//初始化修改的值
        ...
        paramObj.itemid = val;
        this.http.get("/qzlq/getSwxxItemDetailById",paramObj,this.getSwxxItemDetailByIdCallBack,this,false);
      },
      ...
      getSwxxItemDetailByIdCallBack(result){
      ...
      submitEditContent(){//发表评论
        ...
        if(this.selectusers.length==0){
            this.http.post("/qzlq/insertSwxxItemContent",paramObj,this.insertSwxxItemContentCallBack,this,false);
        }else{
            ...
            this.$msgbox({
              ...
              beforeClose: (action, instance, done) => {
                if (action === 'confirm') {
                  ...
                  paramObj.msg = "涉稳信息["+this.itemdata.title+"]主题下添加了关于您的新的信息，请注意查看！";
                  this.http.post("/qzlq/insertSwxxItemContent",paramObj,this.insertSwxxItemContentCallBack,this,false);
                } else {
                  done();
                }
      ...
      deleteReply(val){
          ...
          this.http.get("/qzlq/deleteSwxxItemContent",paramObj,this.deleteSwxxItemContentCallBack,this,false);
      },
      deleteSwxxItemContentCallBack(reslut){
          this.reflashItem(this.itemdata.id);
      },
      editReply(val){
            var obj=JSON.parse(val);
      ...
      replaysubmitEditContent(){
          ...
          this.http.post("/qzlq/updateSwxxItemContent",paramObj,this.updateSwxxItemContentCallBack,this,false);
      },
      updateSwxxItemContentCallBack(result){
          this.showsubmitbtn = "1";
          this.reflashItem(this.itemdata.id);
          this.$refs.ue.setUEContent("");//重置编辑器
      },
      ...
      setItemTop(val){
          ...
          paramObj.itemid = this.itemdata.id;
          if(val==1){
              this.http.get("/qzlq/updateSwxxItemTop",paramObj,this.updateSwxxItemCallBack,this,false);
          }else{
              this.http.get("/qzlq/cancelSwxxItemTop",paramObj,this.updateSwxxItemCallBack,this,false);
          }
      },
      setItemFollow(val){
          var paramObj = {};
          paramObj.itemid = this.itemdata.id;
          if(val==1){
              this.http.get("/qzlq/updateSwxxItemFollow",paramObj,this.updateSwxxItemCallBack,this,false);
          }else{
              this.http.get("/qzlq/cancelSwxxItemFollow",paramObj,this.updateSwxxItemCallBack,this,false);
          }
      },
      deleteItem(){
          var paramObj = {};
          paramObj.itemid = this.itemdata.id;
          this.http.get("/qzlq/deleteSwxxItem",paramObj,this.deleteSwxxItemCallBack,this,false);
      },
      deleteSwxxItemCallBack(){
          this.itemdata = {};
          this.contentlist = [];
          this.page = 1;
          this.totalSize = 0;
      ...
      updateItemstate(val){
          ...
          paramObj.itemid = this.itemdata.id;
          paramObj.state = val;
          this.http.get("/qzlq/updateSwxxItemState",paramObj,this.updateSwxxItemCallBack,this,false);
      },
      updateSwxxItemCallBack(result){
          this.showPop = false;
          this.reflashItem(this.itemdata.id);
      },
      pageChange(page){
...
.swxxfollowpanel >>> .edui-default .edui-editor {
