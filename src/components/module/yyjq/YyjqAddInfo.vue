<template>
    <Modal v-model="showdata.showmodal" :draggable = "true" :footer-hide="true" title="新增扬言警情主题" class-name="yyjqEditItem-panel">
...
export default {
  ...
  methods:{
      addyyjqItem(){
          ...
          this.http.post("/qzlq/insertYyjqItem",addItemParamObj,this.insertyyjqItemCallBack,this,false);
      },
      insertyyjqItemCallBack(result){
