<template>
    <div class="yyjqItemButton" @click="showFollowPanel" @mouseover="mouseOver" @mouseout="mouseOut">
      <div class="yyjqbuttonTX" :class="yyjqbuttonBorder">
        ...
        <div class="content">
            ...
            <div class="caozuo" v-show="showEditIcon" >
              <div class="mdyIcon" @click="edityyjqItem" ></div>
            </div>
         </div>
        <div :class="state">
        </div>
...
export default {
  ...
  data () {
    return {
        ...
        yyjqbuttonBorder:"yyjqbuttonBorder_leave",
    }
  },
  computed: {
    titlespan:function(){
  ...
  methods:{
    ...
    mouseOver(){
       ...
       this.yyjqbuttonBorder="yyjqbuttonBorder_enter";
     },
     mouseOut(){
       this.showEditIcon = false;
       this.yyjqbuttonBorder="yyjqbuttonBorder_leave";
     },
     edityyjqItem(){
         this.$emit("show-edit",true);
     },
     showFollowPanel(){
       this.initRightPaneldata(this.data.id,"yyjq");
     }
  },
  created(){
...
.yyjqbuttonTX:hover, .yyjqbuttonTX:focus, .yyjqbuttonTX:active {
    cursor: pointer;
...
.mdyIcon{
  ...
  margin-right:10px;
  background: 
  url(./../../../assets/yyjq/yyjq_mdy.png)  no-repeat;
}
.state_xinzeng{
  position: absolute;
  right: 5px;
  ...
  height: 45px;
  background: 
  url(./../../../assets/yyjq/yyjq_xinzeng.png)  no-repeat;
}
.state_xubao{
  position: absolute;
  right: 5px;
  ...
  height: 45px;
  background: 
  url(./../../../assets/yyjq/yyjq_xubao.png)  no-repeat;
}
.state_jiechu{
  position: absolute;
  right: 5px;
  ...
  height: 45px;
  background: 
  url(./../../../assets/yyjq/yyjq_jiechu.png)  no-repeat;
}
</style>
