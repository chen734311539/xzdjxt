        ...
        <HfxFollowTemplate  :itemdata="itemdata" :contentlist="contentlist" @on-commentreply="commentReply" @on-editreply="editReply" @on-deletereply="deleteReply" >
            ...
            <template #editfollowpanel="{data}">
                <div class="addueditor">
                    <UE :defaultMsg="defaultMsg" :config="config" ref="ue" ueid="yyjqaddfollow"></UE>
                </div>
  ...
  methods:{
      ...
      submitEditContent(){//发表评论
        ...
        if(this.selectusers.length==0){
            this.http.post("/qzlq/insertYyjqItemContent",paramObj,this.insertyyjqItemContentCallBack,this,false);
        }else{
            ...
            this.$msgbox({
              ...
              beforeClose: (action, instance, done) => {
                if (action === 'confirm') {
                  ...
                  paramObj.msg = "扬言警情["+this.itemdata.title+"]主题下添加了关于您的新的信息，请注意查看！";
                  this.http.post("/qzlq/insertYyjqItemContent",paramObj,this.insertyyjqItemContentCallBack,this,false);
                } else {
                  done();
                }
      ...
      deleteReply(val){
          ...
          this.http.get("/qzlq/deleteYyjqItemContent",paramObj,this.deleteyyjqItemContentCallBack,this,false);
      },
      deleteyyjqItemContentCallBack(reslut){
          this.reflashItem(this.itemdata.id);
      },
      editReply(val){
            var obj=JSON.parse(val);
      ...
      replaysubmitEditContent(){
          ...
          this.http.post("/qzlq/updateYyjqItemContent",paramObj,this.updateyyjqItemContentCallBack,this,false);
      },
      updateyyjqItemContentCallBack(result){
          this.showsubmitbtn = "1";
          this.reflashItem(this.itemdata.id);
          this.$refs.ue.setUEContent("");//重置编辑器
      },
      ...
      setItemTop(val){
          ...
          paramObj.itemid = this.itemdata.id;
          if(val==1){
              this.http.get("/qzlq/updateYyjqItemTop",paramObj,this.updateyyjqItemCallBack,this,false);
          }else{
              this.http.get("/qzlq/cancelYyjqItemTop",paramObj,this.updateyyjqItemCallBack,this,false);
          }
      },
      setItemFollow(val){
          var paramObj = {};
          paramObj.itemid = this.itemdata.id;
          if(val==1){
              this.http.get("/qzlq/updateYyjqItemFollow",paramObj,this.updateyyjqItemCallBack,this,false);
          }else{
              this.http.get("/qzlq/cancelYyjqItemFollow",paramObj,this.updateyyjqItemCallBack,this,false);
          }
      },
      deleteItem(){
          var paramObj = {};
          paramObj.itemid = this.itemdata.id;
          this.http.get("/qzlq/deleteYyjqItem",paramObj,this.deleteyyjqItemCallBack,this,false);
      },
      deleteyyjqItemCallBack(){
          this.itemdata = {};
          this.contentlist = [];
          this.page = 1;
          this.totalSize = 0;
      ...
      updateItemstate(val){
          ...
          paramObj.itemid = this.itemdata.id;
          paramObj.state = val;
          this.http.get("/qzlq/updateYyjqItemState",paramObj,this.updateyyjqItemCallBack,this,false);
      },
...
.yyjqfollowpanel >>> .edui-default .edui-editor {
