<template>
    <Modal v-model="showdata.showmodal" :draggable = "true" :footer-hide="true" title="新增警情质量主题" class-name="zpxaEditItem-panel">
...
export default {
  ...
  methods:{
      addZpxaItem(){
          ...
          this.http.post("/qzlq/insertZpxaItem",addItemParamObj,this.insertZpxaItemCallBack,this,false);
      },
      insertZpxaItemCallBack(result){
