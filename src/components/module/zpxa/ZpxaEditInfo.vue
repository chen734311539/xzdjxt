<template>
    <Modal v-model="showdata.showmodal" :draggable = "true" :footer-hide="true" title="修改警情质量主题" class-name="zpxaEditItem-panel">
      <div slot="close"><div class="hfx-modal-close"/></div>
        <div style="display:block;">
            <div style="height: 570px;">
                <div class="zpxaEditPanel">
                    <div class="modal-div">
                        <span>选择参与部门：</span>
                ...
                <div class="zpxaEditContentPanel">
                    <div class="uespanel">
                        <UE :defaultMsg="defaultMsg" :config="config" ref="ue" ueid="zpxaedit"></UE>
                    </div>
                </div>
            </div>
            <div class="zpxaEditBtn">
                <HfxButton  @click="addZpxaItem" />
                <HfxButton  @click="closeZpxa" name="取消" />
            </div>
        </div>
    </Modal>
</template>
...
export default {
  ...
  computed: mapState({
    ...
    deptListObj: state => state.zpxa.allDeptListObj
  }),
  methods:{
      addZpxaItem(){
          ...
          this.http.post("/qzlq/updateZpxaItem",updateItemParamObj,this.updateZpxaItemCallBack,this,false);
      },
      ...
      getDeptTreeCallBack(data){
         this.$store.dispatch('putChildState',{"key":"zpxa","childkey":"allDeptListObj","value":data});
      },
...
.zpxaEditItem-panel .ivu-modal .ivu-modal-content{
  top:180px;
  left:495px;
