            ...
            <template #titlebutton="{data}">
                ...
                <Poptip v-model="showPop" zIndex="2000" placement="bottom" class="item_option_btn">
                    ...
                    <div slot="content" style="calc(100% - 10px);color:#2d8cf0;min-width:60px">
                        ...
                        <div v-show="itemdata.state!='1'" class="itemoption" @click="updateItemstate(1)">低风险</div>
                        <div v-show="itemdata.state!='2'" class="itemoption" @click="updateItemstate(2)">中风险</div>
                        <div v-show="itemdata.state!='3'" class="itemoption" @click="updateItemstate(3)">高风险</div>
                        <div v-show="itemdata.state!='4'" class="itemoption" @click="updateItemstate(4)">已化解</div>
                    </div>
                  </Poptip>
            </template>
            <template #editfollowpanel="{data}">
                <div class="addueditor">
                    <UE :defaultMsg="defaultMsg" :config="config" ref="ue" ueid="zpxaaddfollow"></UE>
                </div>
...
export default {
  ...
  methods:{
      initEditValues(val){//初始化修改的值
        ...
        paramObj.itemid = val;
        this.http.get("/qzlq/getZpxaItemDetailById",paramObj,this.getZpxaItemDetailByIdCallBack,this,false);
      },
      reflashItem(val){//刷新左边主题
        var paramObj = {};
      ...
      getZpxaItemDetailByIdCallBack(result){
      ...
      submitEditContent(){//发表评论
        ...
        if(this.selectusers.length==0){
            this.http.post("/qzlq/insertZpxaItemContent",paramObj,this.insertZpxaItemContentCallBack,this,false);
        }else{
            ...
            this.$msgbox({
              ...
              beforeClose: (action, instance, done) => {
                if (action === 'confirm') {
                  ...
                  paramObj.msg = "警情质量["+this.itemdata.title+"]主题下添加了关于您的新的信息，请注意查看！";
                  this.http.post("/qzlq/insertZpxaItemContent",paramObj,this.insertZpxaItemContentCallBack,this,false);
                } else {
                  done();
                }
      ...
      deleteReply(val){
          ...
          this.http.get("/qzlq/deleteZpxaItemContent",paramObj,this.deleteZpxaItemContentCallBack,this,false);
      },
      deleteZpxaItemContentCallBack(reslut){
          this.reflashItem(this.itemdata.id);
      },
      editReply(val){
            var obj=JSON.parse(val);
      ...
      replaysubmitEditContent(){
          ...
          this.http.post("/qzlq/updateZpxaItemContent",paramObj,this.updateZpxaItemContentCallBack,this,false);
      },
      updateZpxaItemContentCallBack(result){
          this.showsubmitbtn = "1";
          this.reflashItem(this.itemdata.id);
          this.$refs.ue.setUEContent("");//重置编辑器
      },
      commentReply(val){
          ...
          var content = "引用"+obj.seq+"楼"+obj.insertusername+"的回复："+obj.content+"<p>"+myseq+"楼回复：</p>";
      ...
      setItemTop(val){
          ...
          paramObj.itemid = this.itemdata.id;
          if(val==1){
              this.http.get("/qzlq/updateZpxaItemTop",paramObj,this.updateZpxaItemCallBack,this,false);
          }else{
              this.http.get("/qzlq/cancelZpxaItemTop",paramObj,this.updateZpxaItemCallBack,this,false);
          }
      },
      setItemFollow(val){
          var paramObj = {};
          paramObj.itemid = this.itemdata.id;
          if(val==1){
              this.http.get("/qzlq/updateZpxaItemFollow",paramObj,this.updateZpxaItemCallBack,this,false);
          }else{
              this.http.get("/qzlq/cancelZpxaItemFollow",paramObj,this.updateZpxaItemCallBack,this,false);
          }
      },
      deleteItem(){
          var paramObj = {};
          paramObj.itemid = this.itemdata.id;
          this.http.get("/qzlq/deleteZpxaItem",paramObj,this.deleteZpxaItemCallBack,this,false);
      },
      deleteZpxaItemCallBack(){
          this.itemdata = {};
          this.contentlist = [];
          this.page = 1;
          this.totalSize = 0;
      ...
      updateItemstate(val){
          ...
          paramObj.itemid = this.itemdata.id;
          paramObj.state = val;
          this.http.get("/qzlq/updateZpxaItemState",paramObj,this.updateZpxaItemCallBack,this,false);
      },
      updateZpxaItemCallBack(result){
          this.showPop = false;
          this.reflashItem(this.itemdata.id);
      },
      pageChange(page){
...
.zpxafollowpanel >>> .edui-default .edui-editor {
